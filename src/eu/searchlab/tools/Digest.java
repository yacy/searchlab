/**
 *  Digest
 *  (C) 2008 by Michael Peter Christen; mc@yacy.net, Frankfurt a. M., Germany, @orbiterlab
...
public class Digest {
    ...
    private static final int md5CacheSize = 1000;
    ...
    public static byte[] encodeMD5Raw(final File file) throws IOException {
        ...
        try {
            ...
            log.warn("file not found:" + file.toString(), e);
            return null;
        }
        ...
        try {
            ...
            log.warn("file error with " + file.toString() + ": " + e.getMessage(), e);
