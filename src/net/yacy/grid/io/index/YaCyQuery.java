...
public class YaCyQuery {
    ...
    public QueryBuilder getQueryBuilder() {
        ...
        if (this.orGroupTerms.size() == 1) {
            ...
            for (final String t: this.orGroupTerms) {
                final QueryBuilder partial = parse(t, this.timezoneOffset);
        ...
        if (this.collections != null && this.collections.length > 0) {
            ...
            final BoolQueryBuilder qb = QueryBuilders.boolQuery().must(queryBuilder);
